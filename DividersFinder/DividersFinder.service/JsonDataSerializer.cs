...
namespace DividersFinder.service
{
    ...
    public class JsonDataSerializer : IJsonDataSerializer
    {
        public void Serialize(Dictionary<ulong, List<ulong>> resultOffinding)
        {
            ...
            File.WriteAllText(@"C:\Users\Mario\Source\Repos\dividers_finder\DividersFinder\DividersFinder.service\Writelines5.jso", jsonData);
        }

        public Dictionary<ulong,List<ulong>> Deserialize()
        {
            var readjsonData = File.ReadAllText(@"C:\Users\Mario\Source\Repos\dividers_finder\DividersFinder\DividersFinder.service\Writelines5.json");
